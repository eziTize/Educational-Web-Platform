...
function lightbox_open() {
  var lightBoxVideo = document.getElementById("IntroVideo");
  window.scrollTo(0, 0);
  document.getElementById('v-light').style.display = 'block';
  document.getElementById('v-fade').style.display = 'block';
  lightBoxVideo.play();
}

function lightbox_close() {
  var lightBoxVideo = document.getElementById("IntroVideo");
  document.getElementById('v-light').style.display = 'none';
  document.getElementById('v-fade').style.display = 'none';
  lightBoxVideo.pause();
}
