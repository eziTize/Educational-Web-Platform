function markDayProperties(date_time){
    //$('#selected-date').text(date_time);
    $('#input-selected-date').val(date_time);
    $('#disableDatesModal').modal('show');
}
...
$(document).ready(function () {
    ...
    $('#password').on('keyup change',function () {
        ...
        var passwordChange = checkStrength(password);
        if (passwordChange == false) {
            $('#sign-up').attr('disabled', true);
        }else if(passwordChange == 'Strong'){
