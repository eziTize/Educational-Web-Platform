...
<header class="header-section">
    <div class="container">
        <div class="header-wrapper">
            <div class="logo">
                <a href="{{ url('/') }}">
                    <img src="{{url('custom-theme/assets/images/logo/logo.png')}}" alt="logo" style="height: 4.2vh;">
                </a>
            </div>
            <ul class="menu">
                    <li>
                ...
                @guest
                 ...
                 <!--    <li class="header-button pr-3">
                   ...
                   Or, -->
                    <li class="header-button pr-0" style="margin-top: 20px; margin-bottom: 20px; text-align: center;">
                ...
                @role('teacher')
                   ...
                   <!-- <li>
                    ...
                    @if(url($user['profile_image']))
                     <a id="profile_pic_c" href="{{ route('profile.dashboard') }}">Dashboard
                            <img class="profile-image" src="{{url($user['profile_image'])}}" object-fit="contain" alt="profile-image">
                        </a>
                    @else
                        <a href="{{ route('profile.dashboard') }}">Dashboard
                ...
                @role('student')
                <?php
                    $StudentProfile = App\Models\StudentProfile::where('user_id', $user->id)->firstOrCreate(['user_id' => $user->id]);
                ?>
                    <li>
