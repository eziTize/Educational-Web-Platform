    ...
    <div class="widget-1 widget-offer">
        ...
        <div class="offer-body">
            <div class="offer-item">
                <div class="thumb">
                    <img src="{{url('custom-theme/assets/images/sidebar/offer01.png')}}" alt="sidebar">
                </div>
                <div class="content">
                    <h6>
            ...
            <div class="offer-item">
                <div class="thumb">
                    <img src="{{url('custom-theme/assets/images/sidebar/offer02.png')}}" alt="sidebar">
                </div>
                <div class="content">
                    <h6>
            ...
            <div class="offer-item">
                <div class="thumb">
                    <img src="{{url('custom-theme/assets/images/sidebar/offer03.png')}}" alt="sidebar">
                </div>
                <div class="content">
                    <h6>
