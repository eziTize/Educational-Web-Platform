...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav style="display: flex; justify-content: space-between;">
                <a style="padding-left: 5px" href="{{url('/messages')}}"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">MESSAGES</span> </a>
                <a style="padding-right: 7px" href="{{ url('/dashboard') }}"><i class="fas fa-tachometer-alt"></i>DASHBOARD</a>
                {{-- header buttons 
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Please select or search a contact to start messaging</span></p>
            </div>
            {{-- Typing indicator --}}
