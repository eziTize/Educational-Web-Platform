        ...
        <h5 class="title">Contact Settings</h5>
            <div class="row">
                <div class="form-group col-lg-6">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="First Name" id="name" name="name" value="{{ $student->name }}">
                    @error('name')
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input class="form-control @error('last_name') is-invalid @enderror"  type="text" placeholder="Last Name" name="last_name" id="last_name" value="{{ $student->last_name }}">
                    @error('last_name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group">
                ...
                <input class="form-control  @error('email') is-invalid @enderror" type="email" placeholder="Enter your Mail" name="email" id="email" value="{{ $student->email }}">
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('contact_number') is-invalid @enderror" type="text" placeholder="Enter your Phone Number" name="contact_number" id="contact_number"  value="{{ $student->contact_number }}">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <select name="zone_id" class="js-example-basic-single form-control  @error('zone_id') is-invalid @enderror" id="zone_id">
                        @if($student->zone_id)
                            <option value="{{ $student->zone_id }}" style="background-color: black;">{{ $zone->find($student->zone_id)->zone_name }}</option>
                        @endif
                        @forelse ($timezones as $timezone)
                        @if($timezone['zone_id'] != $student->zone_id)
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control @error('city') is-invalid @enderror" type="text" placeholder="Enter your City" name="city" id="city"  value="{{ $student->city }}">
                    @error('city')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
...
<script>
    $(document).ready(function() {
        ...
        if('{{ $student->address }}'!=null || '{{ $student->address }}'!=''){
            zone_selector.val('{{ $student->zone_id }}');
