...
@section('content')
<section class="main-page-header contact-banner bg_img" data-background="{{url('https://cdn.pixabay.com/photo/2014/10/23/16/58/phone-499991_960_720.jpg')}}">
</section>
<!-- ==========Contact-Section========== -->
<section class="contact-section padding-top">
    <div class="contact-container">
        <div class="bg-thumb bg_img" data-background="{{url('https://cdn.pixabay.com/photo/2015/01/25/21/02/phone-612061_960_720.jpg')}}"></div>
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-7 col-lg-6 col-xl-5">
                    <div class="section-header-3 left-style">
                        ...
                        <p style="color: black;">We’d love to talk about how we can work together. Send us a message below and we’ll respond as soon as possible.</p>
                    </div>
                    <form class="contact-form" id="contact_form_submit" style="color: black;">
                        ...
                        <div class="info-area">
                            <div class="info-item">
                                <div class="info-thumb">
                                    <img src="{{url('custom-theme/assets/images/contact/contact01.png')}}" alt="contact">
                                </div>
                            ...
                            <div class="info-item">
                                <div class="info-thumb">
                                    <img src="{{url('custom-theme/assets/images/contact/contact02.png')}}" alt="contact">
                                </div>
                                <div class="info-content">
                                    <h6 class="title">Email</h6>
                                    <a href="Mailto:info@coachtribe.com">info@coachtribe.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="contact-counter-item">
                    ...
                    <div class="contact-counter-content">
                        <div class="counter-item">
                            ...
                            <h5 class="title" style="color: #F9AA68;">k</h5>
                        </div>
                        <p>Followers</p>
                    </div>
                </div>
